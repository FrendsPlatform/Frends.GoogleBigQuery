...
namespace Frends.GoogleBigQuery.List;
...
public class GoogleBigQuery
{
    ...
    public static async Task<Result> List([PropertyTab] Connection connection, [PropertyTab] Options options, CancellationToken cancellationToken)
    {
        try
        {
